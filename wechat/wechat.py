#!/usr/bin/env python
# coding: utf-8
# Modify base on https://github.com/Urinx/WeixinBot/blob/master/wxbot_project_py2.7/wechat/wechat.py
...
class WeChat(WXAPI):
    ...
    def __init__(self, host='wx.qq.com'):
        ...
        self.save_data_folders = {
            "webwxgetvoice": "./data/voice/",
            "webwxgetmsgimg": "./data/image/",
            "webwxgetvideo": "./data/video/",
        }
        self.cookie_file = ""
        self.pickle_file = ""
        self.log_mode = False # True
        self.exit_code = 0
